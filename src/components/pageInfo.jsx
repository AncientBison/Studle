      ...
      >
        <Typography sx={{ fontWeight: 'bold', display: 'inline-block' }}>
          ...
          <Link
            ...
            target="_blank"
            href={'https://github.com/AncientBison/Studle'}
          >
            here.
          </Link>
          <br />
        ...
        >
          <img
            src={images.homePage_info_hamburger}
            style={{
              width: '15%',
              display: 'inline',
              border: '3px solid ' + mainTheme.palette.contrast.main,
              borderRadius: '10px',
            }}
          />
        </Box>
        ...
        {bigEnoughForSwappingNames && (
          <Box>
            ...
            <SwappingText
              topText={'Ilan Bernstein'}
              bottomText={'Liam Bridgers'}
            />
            <Typography
              display="inline-block"
              sx={{
