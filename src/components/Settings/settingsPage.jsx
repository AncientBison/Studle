  ...
  return (
    <Box margin="2em" width="calc(100%-4em)">
      {Object.entries(settings)
        .filter((settingEntry) => settingsInfo[settingEntry[0]])
        .map((settingEntry) => (
          <SettingToggle
            mainTheme={mainTheme}
...
function SettingToggle(properties) {
  const { mainTheme, id, name, description, checked, handleChange } =
    properties;
  ...
  return (
    <Tooltip
      ...
      title={<Typography display="inline">{description}</Typography>}
